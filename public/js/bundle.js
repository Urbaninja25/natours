...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidXJiYW5pbmphMTEiLCJhIjoiY2xkOHI3bDZuMDFxczNxcDR5NHc0M3N5diJ9.AW2Zz2Ujeo67LTvq0yhfVg';
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51MWdoxBTiOFVZxYWsQbThs3WB5rguVDltC5LRqjgAnGlDPzs3u1MqYDaWXuvj1r7PEnubjTeU73nScwXpZ21jbZp007sHwSU9Y');
          _context.prev = 1;
          _context.next = 4;
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  //get tour id from datase in tour.pug + e(event).target is basically the element which was clicked + როდესაც js დტასეტ ის წამოღებას ცდილობს html იდან (data-tour-id=`${tour.id}) data s შემდგომ რასაც ვარქმევ რეალურად სახელს ამ variable ს ( tour-id ) ,dash ს ვკვეცავთ და არ ვიყენებთ როცა js ში ვიხმობთ იგი კოვერტირდება camalcasenotation ზე
